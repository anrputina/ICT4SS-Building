...
configuration = {'traces':{
		...
		datetime.datetime(2017, 1, 1, 11, 0, 0): 80 + random.randint(-20, 20),
		datetime.datetime(2017, 1, 1, 12, 0, 0): 100 + random.randint(-20, 20),
		datetime.datetime(2017, 1, 1, 13, 0, 0): 100 + random.randint(-20, 20),
		datetime.datetime(2017, 1, 1, 14, 0, 0): 100 + random.randint(-20, 20),
		datetime.datetime(2017, 1, 1, 15, 0, 0): 100 + random.randint(-20, 20),
		datetime.datetime(2017, 1, 1, 16, 0, 0): 100 + random.randint(-20, 20),
		datetime.datetime(2017, 1, 1, 17, 0, 0): 100 + random.randint(-20, 20),
		datetime.datetime(2017, 1, 1, 18, 0, 0): 100 + random.randint(-20, 20),
